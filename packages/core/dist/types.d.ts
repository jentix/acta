...
export type SpecStatus = "draft" | "active" | "paused" | "implemented" | "obsolete";
export type DocumentStatus = AdrStatus | SpecStatus;
export type DocumentId = string;
export type LinkType = "related" | "supersedes" | "replacedBy" | "decidedBy" | "dependsOn" | "validates";
...
export interface ValidationIssue {
    level: "error" | "warning";
    code: "schema_invalid" | "duplicate_id" | "broken_link" | "invalid_link_target" | "missing_section" | "supersedes_cycle" | "superseded_without_replacement" | "implemented_spec_without_proof" | "document_not_found";
    message: string;
